...
ONLY valid JSON. EXACTLY 15 ITEMS. NO MARKDOWN.`, "guest_suggestions")
  ...
  const generateCategoryGuests = async (cat) => {
    ...
    try {
      ...
      CORE PHILOSOPHY: Raj Shamani podcast follows a 70/30 pattern - 70% exclusive voices (domain experts, insiders, niche specialist) and 30% semi-famous recognizable names (NOT Bollywood A-listers, but niche icons like Avadh Ojha, Praggnanandhaa, etc. ).
Category: ${cat.label}. 
...
{view === "outcomes" && (
  ...
  <div style={{ padding: "24px", maxWidth: "900px", margin: "0 auto" }}>
    ...
    <p style={{ color: "#888", fontSize: "13px", marginBottom: "24px" }}>Role: <strong style={{ color: "#4ade80" }}>{(userRole || "viewer").replace("_", " ").toUpperCase()}</strong></p>
